...
## **FUNCIONAMENT** ##
Quan executem el programa surt un comentari que demana que apropem la targeta al lector. Un cop l'aporpem, s'ens obra un menú amb dos opcions:
0.Reading data 1.Writing data
Si li donem a l'opció d'escriure, ens surt el CARD UID, que és el id de la targeta que hem apropat. Tot seguit, ens surt el card SAK i el PICC type

### **VIDEO DE L'EXECUCIÓ** ###
[https://drive.google.com/file/d/1X6pk_q64t4y2T8K3rqXwqe85t5aqKoYO/view?usp=sharing](https://drive.google.com/file/d/1X6pk_q64t4y2T8K3rqXwqe85t5aqKoYO/view?usp=sharing)